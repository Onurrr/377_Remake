			...
			case 946 : //magic instructor
				switch(player.getDialogue().getChatId()) {
					...
					case 10 :
						...
						return true;
					case 11 :
						player.getDialogue().sendNpcChat("If all else falls, visit the Revival-Rs website for a whole", "board of information on quests, skills and minigames", "as well as a very good starter's guide", HAPPY);
						return true;
					case 12 :
			...
			case 2244 : //lumbridge guide
				switch(player.getDialogue().getChatId()) {
					...
					case 3 :
						...
						break;
					case 4 :
						player.getDialogue().sendNpcChat("First I must warn you to take every precaution to", "keep your Revival-Rs password and PIN secure. The", "most important thing to remember is to never give your", "password to, or share your account with, anyone.", CONTENT);
						return true;
					case 5 :
