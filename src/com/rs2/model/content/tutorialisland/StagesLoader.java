...
public enum StagesLoader {
	STAGE_1(1, 1, new int[]{TutorialConstants.LOGOUT_TAB[0]}) {
		...
		public void sendInterfaces(Player player, boolean send) {
			...
			player.getDialogue().sendStartInfo("To start the tutorial use your left mouse-button to click on the", "'Revival-Rs Guide' in this room. He is indicated by a flashing", "yellow arrow above his head. If you can't find him, use your", "keyboard's arrow keys to rotate the view.", "Getting Started", send);
		}
	},
	...
	STAGE_49(49, 1, new int[]{TutorialConstants.ATTACK_TAB[0], TutorialConstants.EQUIPMENT_TAB[0], TutorialConstants.QUEST_TAB[0], TutorialConstants.MUSIC_TAB[0], TutorialConstants.LOGOUT_TAB[0], TutorialConstants.OPTION_TAB[0], TutorialConstants.INVENTORY_TAB[0], TutorialConstants.STATS_TAB[0], TutorialConstants.EMOTE_TAB[0]}) {
		...
		public void sendInterfaces(Player player, boolean send) {
			...
			player.getDialogue().sendStartInfo("Follow the path and you will come to the front of a building.", "This is the 'Bank of Revival-Rs' where you can store all your", "most valued items. To open your bank box just right click on an", "open booth indicated and select use.", "Banking.", send);
		}
	},
