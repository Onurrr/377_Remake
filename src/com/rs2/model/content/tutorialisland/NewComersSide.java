...
public class NewComersSide {
	...
	public void addStarterItems() {
		...
		Item[] starterItems = {new Item(995, 5000),new Item(1351), new Item(590), new Item(303), new Item(315), new Item(1925), new Item(1931), new Item(2309), new Item(1265), new Item(1205), new Item(1277), new Item(1171), new Item(841), new Item(882, 25), new Item(556, 25), new Item(558, 15), new Item(555, 6), new Item(557, 4), new Item(559, 2)};
