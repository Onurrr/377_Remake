	...
	public static void doObjectFirstClick(final Player player) {
		...
		World.submit(new Tick(1, true) {
			...
			public void execute() {
				...
				player.getActionSender().sendMessage("Free of pay!");
				...
				if (id == 14879) { //lumbridge Trap door
					player.teleport(new Position(3208, 9616, 0));
					this.stop();
					return;
				}
				...
				case 6552:
					...
					break;
				case 2073:
					if(System.currentTimeMillis() - player.lastYell < 3000) {
						//player.getActionSender().sendMessage("You can only yell once per 6 seconds!");
						return;
					}
				...
				switch (player.getClickId()) {
					...
					case 2619:
						...
						break;
						 ...
						 break;
						 case 1071 :
							 ShopManager.openShop(player, 168);
							 break;
						 case 2099 :
							 ShopManager.openShop(player, 169);
							 break;
						 case 456 :
							 ShopManager.openShop(player, 170);
							 break;
						 case 902 :
						 BankManager.openBank(player);
						 break;
