...
public class ActionSender {
	...
	public ActionSender sendLogin() {
		...
		player.getPrivateMessaging().sendPMOnLogin();
			sendMessage("Welcome to Revival-Rs");
			sendMessage("Server has been online for: " + Misc.durationFromTicks(World.SERVER_TICKS, false));
			sendMessage("And please join our fresh new forums, WWW.REVIVAL-RS.COM");
		return this;
	}
	...
	public void sendWelcomeScreen() {
		...
		sendString("Welcome to Revival-Rs", 15257);
		sendString("", 15258);
